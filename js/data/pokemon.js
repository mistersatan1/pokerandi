...
(function (global) {
  ...
  var LIST = [
    ...
    P({ id:'zapdos', name:'썬더', tier:'T6', types:["ELECTRIC","FLYING"], role:'CHAIN_DPS', attack:10065, attackSpeed:1.0, range:R.LONG, attackType:'CHAIN', chain:5, skill:'thunderStorm', passive:'legend_zapdos', bossDamage:0.8, desc:'썬더 — CHAIN_DPS 역할의 T6 유닛.' }),
    P({ id:'moltres', name:'파이어', tier:'T6', types:["FIRE","FLYING"], role:'AOE_DPS', attack:8411, attackSpeed:1.0, range:R.LONG, attackType:'SPLASH', splash:130, skill:'skyFire', passive:'legend_moltres', bossDamage:0.8, desc:'파이어 — AOE_DPS 역할의 T6 유닛.' }),
