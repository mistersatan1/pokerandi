...
(function (global) {
  ...
  RPD.Modes = {
    NORMAL: {
      ...
      /* 세션 45: 벽 3.5 → 5.5 — 보스 체력은 벽을 물려받으니 0.35 × 3.5/5.5 = 0.2227 로 같은 814만을 지킨다. */
      modifiers: { finalBossHpMul: 0.2227 }
    },
    ENDLESS: {
    ...
    CHALLENGE: {
      ...
      modifiers: {
        ...
        finalBossHpMul: 0.2227   // 노멀과 같은 70R 보스(벽 5.5 보정) — 따로 재지 않았다(세션 43 · 45)
      }
    }
  };
