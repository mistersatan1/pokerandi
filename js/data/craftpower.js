...
(function (global) {
  ...
  var CFG = { STEEP: 0.6, CAP: 0.35, HIDDEN: 1.5, PULL: 0.75, TIERS: ['T2', 'T3', 'T4', 'T5'],
    IMMORTAL: 2.5, TRANSCEND: 2.8 };   // 불멸·초월 = 재료 합의 몇 배(아래 3번 규칙 · 세션 41 에 1.6/1.8 → 2.5/2.8)
  ...
  CraftPower.build = function () {
     ...
     *    세션 41: 1.6 에선 불멸 2마리가 60R 필드 DPS 를 +20% 밖에 못 올려 벽 넘김이 불멸 없는 판과 같았다(41% · 44%).
     *    2.5 에서 75% — 3.0 도 74% 라 2.5 가 무릎. 초월은 불멸보다 세야 하니 같은 비율(1.8/1.6)로 2.8. */
